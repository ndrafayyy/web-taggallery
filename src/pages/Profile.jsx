  ...
  return (
    ...
    >
      <svg
        ...
        className="h-12 w-12 text-white hover:opacity-75 transition-opacity"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
...
const Profile = () => {
  ...
  return (
    <div>
      ...
      <div
        className="relative w-full h-[643px] bg-gradient-to-br from-[#4B0000] to-[#B30000] overflow-hidden"
        data-aos="fade-in"
      >
        ...
        <div
          className="absolute inset-0 flex flex-col justify-center items-center text-center text-white top-42"
          data-aos="fade-up"
        >
      ...
      "
          ...
          >
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl lg:hidden">
              Ratusan klien dari seluruh Indonesia pernah bekerjasama dengan
              kami. Jangan ragu untuk berdiskusi dengan ngobrol dengan
              kami,GRATIS 24 jam.
            </p>
            ...
            <p className="hidden lg:block mt-6 text-[22px] leading-tight">
              Ratusan klien dari seluruh Indonesia pernah bekerjasama dengan
              kami. Jangan ragu untuk berdiskusi dengan ngobrol dengan kami,
              GRATIS 24 JAM.
            </p>
          </div>
        </div>
      ...
      <div
        className="relative w-full max-w-[1440px] lg:max-w-full mx-auto bg-gradient-to-br from-[#4B0000] to-[#B30000] bg-[url('/assets/foto-ProfilPage/bg-4.png')] bg-cover bg-center bg-blend-multiply text-white text-center py-20 overflow-hidden"
        data-aos="fade-up"
      >
        ...
        <div className="relative z-[10]">
          {" "}
          {/* Pastikan z-index ini lebih tinggi dari elemen tambahan */}
          <h1 className="text-5xl font-bold -mb-6 pt-30" data-aos="fade-down">
            MEET OUR CREATIVE TEAM
          </h1>
          <div className="">
            {/* ===== INI FOTO TAMBAHANNYA (DI BAWAH foto-3) ===== */}
