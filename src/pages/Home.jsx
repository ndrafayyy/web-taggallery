      ...
      <div className=" ">
        ...
        >
          ...
          <div className="ml-4 sm:ml-8 md:ml-28 lg:ml-86 xl:ml-80 lg:-mt-4  ">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-bold leading-tight sm:max-w-160 mt-10 sm:mt-0 ">
              Kami Bantu Brandmu Tampil Berkesan, Berdampak, & Berkelas. Taggallery Agency: Solusi Lengkap untuk Bisnismu
            </h1>
            <p className="ml-1 mt-2.5 text-lg sm:text-xl md:text-2xl lg:text-[24px]">
              Taggallery Agency: Solusi Lengkap Bisnismu
            </p>
            <div className="flex flex-col sm:flex-row gap-2 -mt-2 mb-10 sm:mb-16 md:mb-20 lg:mb-23 relative">
              <button></button>
              <a
            ...
            {/* Trusted by */}
            <div className="flex sm:flex-row items-center gap-4 sm:gap-2 pb-10 sm:pb-16 lg:pb-20 -translate-y-6 ">
      ...
      "
            ...
            <div className="text-white mt-10 lg:mt-0 text-center lg:text-left lg:ml-40 xl:ml-36 2xl:ml-40  lg:max-w-[400px] lg:gap-6">
              ...
              <p className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl lg:hidden">
                Tanggallery adalah Creative Digital Agency yang berdiri sejak 2021 untuk membantu brand go digital, lebih kreatif, dan berdampak.
              </p>
              <p className="mt-3 sm:mt-4 text-base sm:text-lg md:text-xl lg:hidden">
                Kami terdiri dari videografer, fotografer, desainer, ads strategist, dan director yang telah 
                berpengalaman menggarap proyek dari brand lokal hingga nasional.
              </p>

              {/* Hanya muncul di desktop */}
              <p className="hidden lg:block mt-6 text-[22px] leading-tight">
                Tanggallery adalah Creative <br />
                Digital Agency yang berdiri sejak 2021<br />
              ...
              <p className="hidden lg:block mt-4 text-[22px] leading-tight">
                ...
                berpengalaman menggarap proyek dari<br />
        ...
        {/* Artikel Section */}
        <div className="relative w-full max-w-full sm:max-w-4xl md:max-w-5xl lg:max-w-full mx-auto bg-[#8a0000] text-white flex flex-col justify-center p-4 sm:p-6 md:p-8 lg:p-0">
          ...
          <div className="relative bg-[rgba(94,1,0,1)] p-4 sm:p-6 md:p-8 lg:p-10 rounded-t-[80px] sm:rounded-t-[100px] lg:rounded-t-[130px] lg:flex mt-16 sm:mt-20 lg:mt-25 z-[2]">
            <div className="lg:w-1/2 flex flex-col justify-center pb-10 sm:pb-16 lg:pb-26 ml-0 sm:ml-8 lg:ml-12 mb-6 sm:mb-8 lg:mb-0">
            ...
            <div className="lg:w-1/2 -mt-8 sm:mt-8 md:-mt-12 lg:mt-0 lg:-ml-10 sm:lg:-ml-14 lg:-ml-18 space-y-3 sm:space-y-4">
        ...
        <div className="relative w-full max-w-full sm:max-w-4xl md:max-w-5xl lg:max-w-full mx-auto bg-[#8a0000] text-white flex flex-col justify-center p-4 sm:p-6 md:p-8 lg:p-0">
          ...
          <div className="h-auto sm:h-120 lg:h-150 relative bg-[rgba(94,1,0,1)] p-4 sm:p-6 md:p-8 lg:p-10 rounded-t-[80px] sm:rounded-t-[100px] lg:rounded-t-[130px] flex flex-col items-center z-[2] mt-16 sm:mt-20 lg:mt-26">
            <h1 className="mt-4 sm:-mt-16 md:-mb-16 md:-mt-24 lg:-mt-20 text-xl sm:text-2xl font-bold text-center">
              BRANDS GROW WITH TAGGALLERY – YOUR PARTNER IN CREATIVE DIGITAL
              SOLUTIONS
            </h1>
            <div className="mt-4 sm:mt-6 md:mt-12 lg:mt-24 w-full">
              <LogoSlider />
            </div>
          </div>
        </div>
        ...
        >
          <div className="w-full max-w-full sm:max-w-4xl md:max-w-5xl lg:max-w-[1200px] h-full mx-auto flex items-center px-4 sm:px-6 md:px-8">
            <div className=" mt-0 sm:mt-30 max-w-full sm:max-w-3xl md:max-w-4xl text-left ml-0 sm:ml-8 md:ml-12 lg:ml-56">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                GARANSI UANG KEMBALI JIKA TIDAK CAPAI TARGET
              </h1>
              <div className="bg-white h-[2px] w-full max-w-md my-6 sm:my-8"></div>
              <p className="text-base sm:text-lg md:text-xl">
                "Kami berani memberikan garansi uang kembali 
                <br />100% jika target yang disepakati tidak tercapai."
                
              </p>
              <Link to="/contact">
                <button className="bg-[#FF0000] hover:bg-red-700 transition-colors duration-300 text-white px-12 p-1 text-base rounded-2xl mt-8">
                  Discuss Now
                </button>
              </Link>
            </div>
