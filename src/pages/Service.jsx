  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/foto-ServicePage/bg-page.png')",
        }}
        data-aos="fade-in"
      >
        ...
        <div className="relative z-[2] w-full flex flex-col px-4 md:px-10 2xl:max-w-[1260px]">
          <h1
            className="mt-10 md:mt-16 lg:mt-20 text-2xl md:text-3xl lg:text-4xl font-bold text-center lg:text-left lg:ml-54"
            data-aos="fade-down"
          >
